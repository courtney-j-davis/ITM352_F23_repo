...
document.write("</table>");
//Create a button (4.2) to delte the row
//Creating a new HTML button element and assign it to the delteButton variable. 
let deleteButton = document.createElement('button');
//wirte text on bitton to make it more useful
...
//add an event listener to the table to trigger the addNewRow function
